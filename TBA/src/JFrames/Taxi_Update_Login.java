...
public class Taxi_Update_Login extends javax.swing.JDialog {
    private static final long serialVersionUID = 1L;
    DialogMessage dm = new DialogMessage();

    public Taxi_Update_Login(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Taxi_Update_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                Taxi_Update_Login dialog = new Taxi_Update_Login(new javax.swing.JFrame(), true);
